...
<div class="container"> <!--d-none d-sm-block : sm사이즈에서는 보이지 않음 --><!-- d-block d-sm-none : sm에서만 보임 -->
	<div class="row">	
		<div class="col-6 col-md-2 col-lg-2">
			<img src="/resources/xdmin/image/kyobo2_removebg.png"  class="img-fluid mx-auto" onclick="location.href='../visitor/kyobo_Vmain'">
<!-- 			<img src="/resources/xdmin/image/kyobo2_removebg.png"  class="img-fluid mx-auto" onclick="location.href='kyobo_Vmain'"> -->
		</div>				
