...
<link href="/resources/common/css/user/memberForm_Main.css" rel="stylesheet" type="text/css">
...
<hr class="w-100" style="color: #DDDDDD">
	<div class="container my-wrap">
		...
		<div class="d-grid gap-2 col-xs-8 mx-auto">
			<button class="btn btn-list" type="button" onclick="location.href='/xdmin/member/memberForm_page1'" >개인회원</button>	
			<button class="btn btn-list" type="button" onclick="location.href=''">법인회원</button>
			<button class="btn btn-list" type="button" onclick="location.href=''">기존매장/제휴회원</button>
		</div>
