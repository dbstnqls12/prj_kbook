...
<div class="container"> <!-- d-none d-sm-block : sm사이즈에서는 보이지 않음 d-block d-sm-none : sm에서만 보임 -->
	<div class="row">	
		...
		<div class="col-8 d-none d-md-block mt-4 float-end">	
			<div class="row">
				<div class="col" style=" margin-top: 5px; "><img src="/resources/xdmin/image/2.jpg" class="image rounded-circle img-thumbnail float-end" style="width: 50px; height: 50px;"></div>
			</div>
		</div>
